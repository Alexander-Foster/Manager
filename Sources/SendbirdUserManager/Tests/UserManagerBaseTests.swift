...
open class UserManagerBaseTests: XCTestCase {
    open func userManager() -> SBUserManager? { AssignUserManager() }

    public let applicationId = "1DBB77BE-FDEC-4DDD-A622-AFFA23B57859"   // Note: add an application ID
    public let apiToken = "3bedd1126ea2911b54dc41c05cc080ab5d31ec02"        // Note: add an API Token

    public func testInitApplicationWithDifferentAppIdClearsData() throws {
        let userManager = try XCTUnwrap(self.userManager())
        
        // First init
        userManager.initApplication(applicationId: "1DBB77BE-FDEC-4DDD-A622-AFFA23B57859", apiToken: "3bedd1126ea2911b54dc41c05cc080ab5d31ec02")    // Note: Add the first application ID and API Token

        let userId = UUID().uuidString
        let initialUser = UserCreationParams(userId: userId, nickname: "hello", profileURL: nil)
        userManager.createUser(params: initialUser) {
            _ in
        ...
        userManager.initApplication(applicationId: "1DBB77BE-FDEC-4DDD-A622-AFFA23B57859", apiToken: "3bedd1126ea2911b54dc41c05cc080ab5d31ec02")    // Note: Add the second application ID and API Token
